...
<template>
    <div class="flex flex-col bg-sky-600 bg-opacity-35 p-5 rounded-lg shadow-md text-white mt-5 grow">
        ...
        <div v-if="data" class="flex grow mt-5">
            <div class="flex flex-col grow">
                ...
                <div class="flex flex-col grow px-5">
                    ...
                    <span class="text-3xl pl-9">{{ data.current.humidity }}%</span>
                </div> 
            </div>
            <div class="flex flex-col grow">
                <div class="flex flex-col grow px-5">
                    ...
                    <span class="text-3xl pl-9">{{ isCelsius ? data.current.wind_kph : data.current.wind_mph }} {{ tempStore.celsius ? 'km/h' : 'mi/h' }}</span>
                </div>
                <div class="flex flex-col grow px-5">
                    <div class="flex items-center gap-x-2">
                    ...
                    <span class="text-3xl pl-9">{{ data.current.uv }}</span>
                </div> 
            </div>
        </div>
    </div>
