...
<template>
    <div v-if="data" class="flex justify-between w-auto shrink items-center py-5">
        ...
        <span class="text-8xl">{{ Math.round(isCelsius ? data.current.temp_c : data.current.temp_f) }}&deg;</span>
    </div>
</template>