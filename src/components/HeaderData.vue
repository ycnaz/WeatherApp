...
<template>
    <div v-if="data" class="flex justify-between w-auto grow shrink items-center py-5 max-sm:flex-col medium:pb-0">
        <div class="flex flex-col max-sm:mr-auto">
            ...
            <img class="w-24 h-24 medium:w-20 medium:h-20" :src="data.current.condition.icon">
        </div>
