...
<template>
  <div class="h-full w-full relative">
    ...
    <div class="h-full w-full flex p-5 z-10">
      <nav class="flex flex-col bg-sky-600 bg-opacity-50 rounded-lg shadow-md z-10">
        <div class="group flex justify-center items-center w-16 h-16 m-2 rounded-lg bg-sky-700 transition-all duration-300">
          <LogoComp class="w-10 h-10 group-hover:scale-125 transition-all duration-300" />
        </div>
        <div class="group flex flex-col justify-center items-center w-16 h-16 m-2 rounded-lg hover:bg-sky-700 transition-all duration-300 cursor-pointer">
        ...
        <div @click="settingToast" class="group flex justify-center items-center mt-auto w-16 h-16 m-2 rounded-lg hover:bg-sky-700 transition-all duration-300 cursor-pointer">
